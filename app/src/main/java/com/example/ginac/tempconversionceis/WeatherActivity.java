...
public class WeatherActivity extends AppCompatActivity implements OnCheckedChangeListener, OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if(btnFah.isChecked()) {
            ...
            lblOutputDegC.setText((Math.round((temp-32)*5/9))+" degrees C");
            lblOutputDegK.setText((Math.round((temp+459.67)*5/9))+" degrees K");
            answer = (temp-32)*5/9;
        }
